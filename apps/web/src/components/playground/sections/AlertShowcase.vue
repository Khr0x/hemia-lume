...
<template>
  <div class="space-y-8">
    ...
    <!-- Quick preview -->
    <ShowcaseCard title="Preview" description="Default alert rendering">
    ...
    <div id="section-variants">
      <ShowcaseCard title="Variants" description="Available style variants">
        <div class="space-y-4">
          <div class="flex flex-col gap-4">
            ...
            <Alert variant="tonal" class="max-w-md">
    ...
    <!-- With Icon -->
    <div id="section-icon">
      <ShowcaseCard title="With Icon" description="Alert with leading icon">
        <div class="space-y-4">
          <Alert class="max-w-md">
          ...
          <Alert variant="warning" class="max-w-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-amber-600 dark:text-amber-400"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>
            <AlertTitle>Warning</AlertTitle>
            <AlertDescription>
              Please review before proceeding.
            </AlertDescription>
          ...
          <Alert variant="info" class="max-w-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-blue-600 dark:text-blue-400"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
    ...
    <div id="section-actions">
      <ShowcaseCard title="With Actions" description="Alerts with action buttons">
        <div class="space-y-4">
          <Alert class="max-w-md">
    ...
    <!-- Complex Example -->
    <div id="section-complex">
      <ShowcaseCard title="Complex Examples" description="Real-world alert compositions">
        <div class="space-y-6">
          <!-- Success -->
          <div>
    ...
    <div id="section-usage">
      <ShowcaseCard title="Usage" description="How to use the Alert component">
